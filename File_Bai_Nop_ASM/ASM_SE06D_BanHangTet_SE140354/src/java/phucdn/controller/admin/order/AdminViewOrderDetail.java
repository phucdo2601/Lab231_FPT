...
public class AdminViewOrderDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<OrderDetailDTO> result = ordDAO.userFindOrderDetailByPrimaryKey(id);
            if (result != null) {
                request.setAttribute("AVdetail", result);
            }
        } catch (Exception e) {
            log("Error at AdminViewOrderDetail: "+e.getMessage());
            e.printStackTrace();
        }
        finally{
