 ...
 * @author phucd
 */
@WebServlet(name = "AdminEditCategoryServlet", urlPatterns = {"/AdminEditCategoryServlet"})
public class AdminEditCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CategoryDTO cateDto = cateDAO.findCateByPrimaryKey(id);
            request.setAttribute("cateDto", cateDto);
        } catch (Exception e) {
            log("Error at AdminEditCategoryServlet: "+e.getMessage());
            e.printStackTrace();
        }
        finally{
