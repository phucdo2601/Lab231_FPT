 ...
 * @author phucd
 */
@WebServlet(name = "AdminDeleteCategorySevlet", urlPatterns = {"/AdminDeleteCategorySevlet"})
public class AdminDeleteCategorySevlet extends HttpServlet {
