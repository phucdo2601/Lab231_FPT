 ...
 * @author phucd
 */
@WebServlet(name = "UserViewHistoryServlet", urlPatterns = {"/UserViewHistoryServlet"})
public class UserViewHistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<OrderDTO> dto = dao.findOrderByPrimaryKeyHistory(id);
            request.setAttribute("historyPurchase", dto);
        } catch (Exception e) {
