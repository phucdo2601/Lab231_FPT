 ...
 * @author ASUS
 */
@WebServlet(name = "SearchByCateIDController", urlPatterns = {"/SearchByCateIDController"})
public class SearchByCateIDController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //load all Product by cate
            List<ItemDTO> listProByCateID = itDAO.findItemByCateID(cateID);
            request.setAttribute("listProduct", listProByCateID);
            
            //load las
        } catch (Exception e) {
            log("Error at SearchByCateIDController: " + e.getMessage());
            e.printStackTrace();
        } finally {
