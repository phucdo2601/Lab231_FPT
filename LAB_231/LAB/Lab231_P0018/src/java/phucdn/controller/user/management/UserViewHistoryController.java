 ...
 */
package phucdn.controller.user.management;
...
public class UserViewHistoryController extends HttpServlet {
    ...
    private static final String SUCCESS = "historyPurchase.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<BookingDTO> listHisByUserID = bookDAO.loadHistoryBookingByUserID(id);
            url = SUCCESS;
            request.setAttribute("historyPurchase", listHisByUserID);
        } catch (Exception e) {
