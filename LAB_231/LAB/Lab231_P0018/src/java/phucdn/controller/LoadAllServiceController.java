 ...
 * @author ASUS
 */
@WebServlet(name = "LoadAllServiceController", urlPatterns = {"/LoadAllServiceController"})
public class LoadAllServiceController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Load All Product 
            List<ItemDTO> listAllItem = itDAO.loadAllItems();
            request.setAttribute("listProduct", listAllItem);
        } catch (Exception e) {
