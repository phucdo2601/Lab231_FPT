 ...
 * @author ASUS
 */
@WebServlet(name = "AdminEditItemController", urlPatterns = {"/AdminEditItemController"})
public class AdminEditItemController extends HttpServlet {

    private static final String SUCCESS = "adminEdit.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ItemDTO loadItemByID = itDAO.findItemByPrimaryKey(id);
            List<CategoryDTO> listCate = cateDAO.loadAllCates();
            if (loadItemByID != null) {
                url = SUCCESS;
                request.setAttribute("itemByID", loadItemByID);
            ...
            log("Error at AdminEditItemController: "+e.getMessage());
        }
        finally{
