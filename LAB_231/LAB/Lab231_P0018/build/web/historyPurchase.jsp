<%-- 
    ...
    Created on : June 6, 2021, 8:47:02 PM
    Author     : ASUS
--%>
                    ...
                    <tbody>
                        <c:forEach var="dto" items="${requestScope.historyPurchase}" varStatus="counter">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p>${dto.dateOfCreate}</p>
                                    </td>
                                    <td>
                                        <p>${dto.paymentMethod}</p>
                                    </td>	
                                    <td>
                                        <c:if test="${dto.status == 'Finish'}">
                                            <p>
                                                <font color="green">
                                                Done
                                                </font>
                                    ...
                                    <td>
                                        <c:url var="viewOrderDetail" value="MainController">
                                            <c:param name="action" value="viewOrderDetails" />
                                            <c:param name="id" value="${dto.bookingID}" />
                                        </c:url>
