                            ...
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    ...
                                    <c:if test="${sessionScope.USERNAME != 'admin'}">
                                        ...
                                        <li><a href="MainController?action=Logout" ><i class="fa fa-lock"></i>Logout</a></li>
                                        ...
                                        <ul role="menu" class="sub-menu">
                                            ...
                                            <c:if test="${sessionScope.roleAcc == 'user'}">
                                                <c:url var="historyPayment" value="MainController">
                                                    <c:param name="action" value="UViewHistory"/>
                        ...
                        <div class="col-sm-3">
                            <div >
                                <form action="MainController" method="POST" class="search_box pull-right">
                                    ...
                                    <button type="submit" name="action" value="USearchByProductByItemName">
