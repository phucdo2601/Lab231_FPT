                        ...
                        <div class="col-sm-9 padding-right">
                            <div class="product-details"><!--product-details-->
                                <div class="col-sm-5">
                                    <div class="view-product">
                                        <img src= 'images/${detail.imgUrl}' alt= />
                                    <!--                                        <h3>ZOOM</h3>-->
                                </div>
                            ...
                            <div class="col-sm-7">
                                <div class="product-information"><!--/product-information-->
                                    ...
                                    <p><b>Date of Post:</b> ${detail.dateOfCreate} </p>
                                    
                                    <p><b>Brand:</b> E-SHOPPER</p>
                                    <form action="MainController" method="POST" class="productinfo text-center">
                                        <input type="hidden" name="txtProductID" value="${detail.itemID}" />
                                                <input type="hidden" name="txtProductName" value="${detail.itemName}" />
                                                <input type="hidden" name="txtImage" value="${detail.imgUrl}" />
                                    ...
                                    <div class="col-sm-12">
                                        <ul style="background-color: #E0E0DA">
                                            ...
                                            <li><a href=""><i class="fa fa-clock-o"></i>
                                                    <fmt:formatDate type="time" value="${detail.dateOfCreate}"/>

                                                </a></li>
                                            <li><a href=""><i class="fa fa-calendar-o"></i>
                                                    <fmt:formatDate type="date" value="${detail.dateOfCreate}"/>
                                                </a></li>
                                        </ul>
                                            ...
                                            <div class="product-image-wrapper">
                                                <div class="single-products">
                                                    <div class="productinfo text-center">
                                                        ...
                                                        <p><a href="DetailController?productID=${dto.itemID}&cID=${dto.cateID}">${dto.itemName}</a></p>
                                                        <form action="MainController" method="POST">
                                                            <input type="hidden" name="txtProductID" value="${dto.itemID}" />
                                                            <input type="hidden" name="txtProductName" value="${dto.itemName}" />
                                                            <input type="hidden" name="txtImage" value="${dto.imgUrl}" />
                                        ...
                                        <c:forEach items="${requestScope.listRecommend}" var="dto">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="product-image-wrapper">
                                                    <div class="single-products">
                                                        <div class="productinfo text-center">
                                                            <img style="max-height: 150px; min-width: 150px" src="images/${dto.imgUrl}" alt="" />
                                                            <h2>${dto.price} USD</h2>
                                                            <p><a href="DetailController?itemID=${dto.itemID}&cID=${dto.cateID}">${dto.itemName}</a></p>
                                                            <form action="MainController" method="POST" class="productinfo text-center">
                                                                <input type="hidden" name="txtProductID" value="${dto.itemID}" />
                                                                <input type="hidden" name="txtProductName" value="${dto.itemName}" />
                                                                <input type="hidden" name="txtImage" value="${dto.imgUrl}" />
